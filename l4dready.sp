...
public Action eventRoundEndCallback(Event event, const char[] name, bool dontBroadcast)
{
	#if READY_DEBUG
...
public Action eventVoteStarted(Event event, const char[] name, bool dontBroadcast)
{
	char issue[128];
	char param1[128];
	int team;
...
public Action eventVoteEnded(Event event, const char[] name, bool dontBroadcast)
{
...
public Action SendVoteRestartPassed(int client, int args)
{
...
public Action SendVoteRestartStarted(int client, int args)
{
